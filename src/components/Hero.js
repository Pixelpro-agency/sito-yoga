        ...
        <div className='flex flex-col items-center lg:flex-row lg:items-start pt-32 lg:pt-32'>
          <div className='flex-1 lg:mt-12'>
            <h1
              ...
              data-aos-delay='500'
            >
              Yoga per <br /> Allontanare lo Stress
            </h1>
            <p
            ...
            Lo yoga è uno stile di vita, non un lavoro di routine. <br></br> Aiuta a contrastare lo
            stress della vita moderna diventando più consapevoli e positivi
            </p>
            <div
