      ...
      <div className='container mx-auto'>
        ...
        <div className='flex flex-col lg:flex-row lg:gap-x-8'>
          <div className='flex-1' data-aos='fade-right'>
            ...
            Il modo migliore per  <br /> iniziare lo Yoga
            </h2>
          </div>
          <div className='flex-1' data-aos='fade-left'>
            <p className='max-w-[360px] mb-[18px] lg:mb-[38px]'>
            Praticalo ovunque, in qualsiasi momento. Esplora un nuovo modo di allenarti e
            scopri di più te stesso. Stiamo fornendo il meglio
            </p>
            <button className='btn btn-sm btn-orange'>Iniziamo</button>
          </div>
        </div>
      </div>
      {/* video */}
