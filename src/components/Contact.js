      ...
      <div className='container mx-auto'>
        ...
        >
          ...
          >
            ...
            Mettiti in contatto con noi per il tuo corso di yoga
            </h2>
            <p className='mb-7 lg:mb-0'>
            Contattaci per qualsiasi tipo di problema. Siamo qui per darti
            il meglio e anche per aiutarti a trovare il tuo corso di yoga perfetto
            </p>
          </div>
          <form
